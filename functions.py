...
feature_reducers = {
    'Zero Crossing Rate':  [numpy.mean, numpy.std],
    'Energy': [numpy.sum, numpy.std],
    'Entropy of Energy': [numpy.sum, numpy.std],
    'Spectral Centroid': [numpy.mean, numpy.std],
    'Spectral Spread': [numpy.mean, numpy.std],
    'Spectral Entropy': [numpy.mean, numpy.std],
    'Spectral Flux': [numpy.mean, numpy.std],
    'Spectral Rolloff': [numpy.mean, numpy.std],
    'MFCC1': [numpy.mean, numpy.std],
    'MFCC2': [numpy.mean, numpy.std],
    'MFCC3': [numpy.mean, numpy.std],
    'MFCC4': [numpy.mean, numpy.std],
    'MFCC5': [numpy.mean, numpy.std],
    'MFCC6': [numpy.mean, numpy.std],
    'MFCC7': [numpy.mean, numpy.std],
    'MFCC8': [numpy.mean, numpy.std],
    'MFCC9': [numpy.mean, numpy.std],
    'MFCC10': [numpy.mean, numpy.std],
    'MFCC11': [numpy.mean, numpy.std],
    'MFCC12': [numpy.mean, numpy.std],
    'MFCC13': [numpy.mean, numpy.std],
    'Chroma Vector 1': [numpy.mean, numpy.std],
    'Chroma Vector 2': [numpy.mean, numpy.std],
    'Chroma Vector 3': [numpy.mean, numpy.std],
    'Chroma Vector 4': [numpy.mean, numpy.std],
    'Chroma Vector 5': [numpy.mean, numpy.std],
    'Chroma Vector 6': [numpy.mean, numpy.std],
    'Chroma Vector 7': [numpy.mean, numpy.std],
    'Chroma Vector 8': [numpy.mean, numpy.std],
    'Chroma Vector 9': [numpy.mean, numpy.std],
    'Chroma Vector 10': [numpy.mean, numpy.std],
    'Chroma Vector 11': [numpy.mean, numpy.std],
    'Chroma Vector 12': [numpy.mean, numpy.std],
